                ...
                <div className="auth-container">
                    <div className="auth-card">
                        ...
                        <div className="auth-card-left">
                            ...
                            <h1 className="auth-hero-title">Music Analytics Powered by AI</h1>
                            <p className="auth-hero-description">
                                Unlock deep insights into your listening habits with machine learning and data visualization
                            </p>
                        </div>

                        {/* Right Side - Form */}
                        <div className="auth-card-right">
                            <h2 className="auth-title">Connect Your Spotify</h2>
                            <p className="auth-description">
                                Discover patterns in your music taste, analyze your top tracks and artists, and get AI-powered recommendations.
                            </p>
